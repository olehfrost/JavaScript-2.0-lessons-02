...
function t12() {
    ...
    document.querySelector('.out-12').textContent = 'Hello' + ' ' + data1 + ' ' + data2;
}
...
function t16() {
    ...
    document.querySelector('.out-16').innerHTML = data1 + data2;
}
...
function t19() {
    ...
    document.querySelector('.out-19').innerHTML = parseFloat(data1) + parseFloat(data2);
}
